  ...
  return (
    <div data-testid="share-link-row" className="bg-card space-y-3 rounded-md border p-3">
      <div className="flex items-center gap-2">
        ...
        {locked ? (
          <span className="ml-auto inline-flex items-center gap-1 rounded-full bg-red-100 px-2 py-0.5 text-[10px] font-medium text-red-800 dark:bg-red-900/40 dark:text-red-300">
