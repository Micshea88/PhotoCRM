...
const CATEGORY_CLASSES: Record<LeadStatusCategory, string> = {
  client: "bg-emerald-500/10 text-emerald-700 border-emerald-500/30 dark:text-emerald-300",
  lead: "bg-blue-500/10 text-blue-700 border-blue-500/30 dark:text-blue-300",
  referral_partner: "bg-violet-500/10 text-violet-700 border-violet-500/30 dark:text-violet-300",
  vendor: "bg-amber-500/10 text-amber-700 border-amber-500/30 dark:text-amber-300",
  other:
