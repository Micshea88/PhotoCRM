  ...
  return (
    <div data-testid="share-link-row" className="bg-card space-y-3 rounded-md border p-3">
      <div className="flex items-center gap-2">
        ...
        {locked ? (
          <span className="text-3xs ml-auto inline-flex items-center gap-1 rounded-full bg-[var(--color-destructive)]/10 px-2 py-0.5 font-medium text-[var(--color-destructive)]">
